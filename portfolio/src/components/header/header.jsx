...
class Header extends Component {
    ...
    render() { 
        ...
        <div className="container">
          <a className="navbar-brand" href="index.html">Fred</a>
          ...
          <div className="collapse navbar-collapse" id="ftco-nav">
            <ul className="navbar-nav nav ml-auto">
              ...
              <li className="nav-item"><a href="#services-section" className="nav-link"><span>Services</span></a>
              </li><li className="nav-item"><a href="#skills-section" className="nav-link"><span>Skills</span></a></li>
